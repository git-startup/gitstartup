                  ...
                  <div class="col-lg-12">
                    <div class="p-5">
                      <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4"> اضافة تصنيف للمقالات </h1>
                      </div>
                      <form class="user" method="post" action="{{ route('dashboard.addCategory') }}">
                        @csrf
                        ...
                        <div class="form-group text-right">
                            <label for="status"> تحت اي تصنيف </label>
                            <select id="parent_id" name="parent_id" class="form-control text-right">
                              <option value=""></option>
                            </select>
